...
//    Next(And(Var("a"), Var("b"))).simplify shouldEqual And(Next(Var("a")), Next(Var("b")))
//    Next(Or(Var("a"), Var("b"))).simplify shouldEqual Or(Next(Var("a")), Next(Var("b")))
//    Next(Impl(Var("a"), Var("b"))).simplify shouldEqual Or(Neg(Next(Var("a"))), Next(Var("b")))
//    Next(Eq(Var("a"), Var("b"))).simplify shouldEqual Eq(Next(Var("a")), Next(Var("b"))).simplify
//    Next(Neg(False)).simplify shouldEqual Neg(Next(False))
//  }
//
//
//}
